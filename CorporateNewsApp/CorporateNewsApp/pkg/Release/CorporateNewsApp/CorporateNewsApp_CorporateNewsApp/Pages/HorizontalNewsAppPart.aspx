...
<head runat="server">
    ...
    <link rel="stylesheet" href="../Css/HorizontalNewsAppPart.css" />
    ...
    <script type="text/javascript" src="../Scripts/HorizontalNewsAppPart.js"></script>
...
<body class="bodySliderKit">
    ...
    <div class="sliderkitContainer">
        ...
        <!-- Start carousel -->
	    <div id="carousel-horizontal" class="sliderkit">
		    <div class="sliderkit-nav">
			    <div class="sliderkit-nav-clip">
				    <ul id="sliderkit-nav-clip-ul">
				    </ul>
			    </div>
