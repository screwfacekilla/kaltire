...
<asp:Content ID="ContentPageTitle" ContentPlaceHolderID="PlaceHolderPageTitleInTitleArea" runat="server">
    ...
    <script type="text/javascript">$('#page-help-title-area').append(Resource_Horizontal_Help_Title);</script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <script type="text/javascript">$(document).attr('title', Resource_Horizontal_Help_Title);</script>
    ...
    <div class="help-content">
        ...
        <p id="help-intro"></p>
        <script type="text/javascript">$('#help-intro').append(Resource_Horizontal_Help_Introduction);</script>
        
        <h2 id="how-to-manage-news"></h2>
        <script type="text/javascript">$('#how-to-manage-news').append(Resource_How_To_Manage_News);</script>

        <p id="horizontal-lists-intro"></p>
        <script type="text/javascript">$('#horizontal-lists-intro').append(Resource_Horizontal_Lists_Intro);</script>
        
        <p id="horizontal-lists-fill"></p>
        <script type="text/javascript">$('#horizontal-lists-fill').append(Resource_Horizontal_List_Fill);</script>
        ...
        <script type="text/javascript">$('#edit-carousel-add-app-part').append(Resource_Horizontal_Add_App_Part);</script>

        <img src="../Images/HorizontalNewsHelp01.png" alt="Carousel News Help"/>
        ...
        <img src="../Images/HorizontalNewsHelp02.png" alt="Carousel News Help"/>
        <p>&nbsp;</p>
        ...
        <script type="text/javascript">
            ...
            $('#table-property-transition-description').append(Resource_Horizontal_Property_Transition_Description);
            ...
            $('#table-property-speed-description').append(Resource_Horizontal_Property_Speed_Description);
